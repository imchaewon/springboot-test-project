package com.example.java_.jsonParsing.org_json.string_to_json;
...
public class Run {
	public static void main(String[] args) {
		...
		String createDate = (String) first.get("CREATE_DATE");
